...
public class DemoController {
    ...
    @RequestBody Message_Repo message){
        return ResponseEntity.ok(new Message_Repo ("Hello World",22));
    }
  ...
  /*     @PostMapping("/something")
    ...
    @PostMapping("/something")
    public ResponseEntity<Message_Repo> postSomething(@RequestBody Message_Repo message) {
